    ...
    def p_sample(
        ...
        **kwargs,
        ...
        if "record_traj" in model_kwargs and model_kwargs["record_traj"]:
            ...
            if not os.path.exists(f"traj_imgs/baseline/{ccount}/"):
                os.mkdir(f"traj_imgs/baseline/{ccount}/")
            ...
            plt.axis('off')
            myt = t.max().cpu().item()
            plt.savefig(f"traj_imgs/baseline/{ccount}/recon_timestep_{myt}.png")
            ...
            plt.imshow(image)
            plt.axis('off')
            plt.savefig(f"traj_imgs/baseline/{ccount}/xprev_timestep_{myt}.png")
