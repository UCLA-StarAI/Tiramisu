...
class ProgressBar():
    def __init__(self, total_epochs, total_batches, statistics_name = [], cumulate_statistics = False, report_every = 1):
    ...
    def new_epoch_begin(self):
        ...
        self.next_print_step = self.report_every
    ...
    def new_batch_done(self, statistics_val = None, n = 1):
        ...
        if self.cumulate_statistics:
            ...
            if self.current_batch > self.next_print_step:
                while self.current_batch > self.next_print_step:
                    self.next_print_step += self.report_every
